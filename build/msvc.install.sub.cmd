...
copy /Y /B "output\bin\*" "%INSTALL_PATH_BIN%\"
...
copy /Y /B "output\bin\*" "%INSTALL_PATH_DEV%\bin"
copy /Y /B "output\include\*" "%INSTALL_PATH_DEV%\include"
copy /Y /B "output\lib\civetweb.lib" "%INSTALL_PATH_DEV%\lib\civetweb.lib"
copy /Y /B "output\lib\civetweb.lib" "%INSTALL_PATH_DEV%\lib\civetweb.static.lib"
